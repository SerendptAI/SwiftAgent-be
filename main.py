...
app.mount("/email-assets/fonts", StaticFiles(directory="app/email_templates/fonts"), name="email-fonts")
app.mount("/email-assets", StaticFiles(directory="app/email_templates/images"), name="email-assets")
